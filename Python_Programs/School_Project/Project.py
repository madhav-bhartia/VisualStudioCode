...
try:
    mycur.execute("USE school_db;")
except Exception as exception:
    print(f"An error occurred while trying to use school_db: {exception}")
    flag = False
...
def create_all():
    ...
    create_table_classes = "CREATE TABLE classes(class_id INT PRIMARY KEY, class_name Varchar(10) NOT NULL);"
...
def manage_classes():
    ...
    match choice:
        case 1:
            ...
            query = f"INSERT INTO classes (class_id, class_name) VALUES ({class_number}, '{class_name}');"
            mycur.execute(query)
